...
import HomeLaunchBannerSection from '../../../Userpanel/pages/home/sections/HomeLaunchBannerSection.jsx'
import { getApiBase, getJson, putJson } from '../../services/apiClient.js'
import { uploadImage } from '../../services/files.js'

const KEY = 'home-launch-banners'
...
export default function HomeLaunchBannersCms() {
  ...
  const onSave = async () => {
    ...
    if (!normalized.length) {
      setError('Please add at least 1 banner image')
      return
    }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          <div className="text-sm font-semibold text-gray-900">Home Launch Banners CMS</div>
          <div className="mt-1 text-sm text-gray-600">Manage section title, description, and 3 banner images</div>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              rows={3}
              placeholder="Explore the latest campaigns, highlights, and just-dropped collections."
        ...
        <div className="grid gap-6">
          {items.map((it, idx) => (
            <div key={idx} className="grid gap-4 md:grid-cols-2">
              <div>
                <div className="text-xs font-semibold text-gray-600">Banner image {idx + 1}</div>
                <div
                ...
                >
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <button
                      ...
                      onClick={() => {
                        if (loading || uploadingIdx !== -1) return
                        document.getElementById(`home-launch-banners-image-${idx}`)?.click()
                      }}
                      disabled={loading || uploadingIdx !== -1}
                ...
                <input
                  id={`home-launch-banners-image-${idx}`}
                  type="file"
