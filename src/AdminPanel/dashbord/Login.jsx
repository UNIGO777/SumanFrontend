...
export default function AdminLogin() {
  ...
  const onSubmit = (e) => {
    ...
    setIsLoading(true)
    adminLoginVerify({ email, otp: otp.trim(), keepLoggedIn })
      .then((data) => {
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      disabled={isLoading}
                      className="h-12 w-full rounded-lg border border-gray-200 px-4 pr-12 text-sm text-gray-900 outline-none focus:border-gray-300"
                    />
                    <button
                      type="button"
