    ...
    <div className="bg-white">
      <div className="w-full bg-gray-100">
        <div className="w-full px-8 py-10 text-center sm:px-12 md:px-8 lg:px-14">
          <div className="text-4xl font-semibold text-gray-900">Return Policy</div>
      ...
      <div className="w-full px-8 py-10 sm:px-12 md:px-8 lg:px-14">
        <div className="mx-auto max-w-4xl space-y-8 text-sm text-gray-700">
          ...
          <div className="space-y-2">
            <div className="text-lg font-semibold text-gray-900">Damaged / incorrect items</div>
            <div>
          ...
          <div className="space-y-2">
            <div className="text-lg font-semibold text-gray-900">Refunds</div>
            <div>
